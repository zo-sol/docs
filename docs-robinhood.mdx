...
|------|---------:|----------|----------|-------------|
| `sepolia` | 11155111 | ETH | [`0x246A08D9fdD9b3990A88eD1f2DF1A87239839F07`](https://sepolia.etherscan.io/address/0x246A08D9fdD9b3990A88eD1f2DF1A87239839F07) | `https://rpc.sepolia.org` |
...
<Warning>
Robinhood Chain is chain ID `4663`. It is a separate network from Ethereum mainnet and Arbitrum One, so ETH must be bridged in before it can be spent there.
</Warning>
...
// Submit a fortune (a small inline row costs the 0.00012 ETH basic fee)
