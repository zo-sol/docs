...
| **पैरामीटर्स** | `accountInfo`: टेबल अकाउंट जानकारी |
|----------------|--------------------------|
| **रिटर्न** | पंक्ति ऐरे (Row[]) |
...
किसी विशेष अकाउंट के सभी ट्रांजैक्शन्स प्राप्त करता है।

| **मॉड्यूल** | `reader` |
|------------|----------|
| **यूज़ केस** | ट्रांजैक्शन इतिहास, अकाउंट विश्लेषण, डिबगिंग |
